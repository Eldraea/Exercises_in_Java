...
Created by Eldr@e@
------------------------------------------------------------------------------------------------------------------------
Challenge: For this exercise you will create four classes of vehicles. The first class should be named Car. This will be
           the base class for three other classes, Mitsubishi, Holden and Ford.
           The first class contains fou members variables, or fields with these names and conditions:
           ...
           four wheels. So the other two fields should bet set to default values.
           In addition, there are five other methods. These methods should be defined as described below:
              - startEngine accepts no parameters and returns a message which says that the ca's engine is starting.
              - accelerate accepts no parameters and returns a message that says the car is accelerating
              - brake accepts no parameters ans returns a message stat says the car is braking.
           ...
           will override the three parent methods startEngine, accelerate, and brake.
